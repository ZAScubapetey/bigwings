...
const u = {
  ...
  trigger(n, t, e) {
    ...
    return (
      s &&
        Me &&
        ((o = Me.Event(t, e)), Me(n).trigger(o), (a = !o.isPropagationStopped()), (l = !o.isImmediatePropagationStopped()), (d = o.isDefaultPrevented())),
      r
...
function no(n, t, e) {
  return function i(s) {
    const r = n.querySelectorAll(t);
    for (let { target: o } = s; o && o !== this; o = o.parentNode)
      for (const a of r) if (a === o) return mn(s, { delegateTarget: o }), i.oneOff && h.off(n, s.type, t, e), e.apply(o, [s]);
  };
}
    ...
    $e(this, "initMDB", (t, e = !1) => {
      const i = Object.keys(gt).map((s) => {
        if (!!document.querySelector(gt[s].selector)) {
          const o = t[gt[s].name];
          return (
            !o && !fe.get(s) && e && console.warn(`Please import ${gt[s].name} from "MDB" package and add it to a object parameter inside "initMDB" function`),
            o
          );
        }
        return null;
...
class Ds extends ao {
  constructor(t) {
    super(t),
      (this._fn = {}),
      this._element &&
        (et.setData(this._element, on, this), this._init(), _.setDataAttribute(this._element, `${this.constructor.NAME}-initialized`, !0), H(this.constructor));
  }
  // Static
  static get NAME() {
    return Os;
  ...
  _bindListHideTransitionEnd() {
    u.on(this._buttonList, _t, (t) => {
      t.propertyName === "transform" &&
        (u.off(this._buttonList, _t), (this._element.style.height = `${this._initialContainerHeight}px`), u.trigger(this._element, ho));
    });
  }
...
class _e extends Kt {
  ...
  _initEvents() {
    this._supportPointerEvents
      ? (h.on(this._element, ea, (t) => this._start(t)), h.on(this._element, na, (t) => this._end(t)), this._element.classList.add(ra))
      : (h.on(this._element, Zo, (t) => this._start(t)), h.on(this._element, Jo, (t) => this._move(t)), h.on(this._element, ta, (t) => this._end(t)));
  }
...
function pi(n) {
  ...
  if (d) {
    var T = Ut(e),
      ...
      w = "clientWidth";
    if (
      (T === j(e) && ((T = st(e)), Z(T).position !== "static" && a === "absolute" && ((A = "scrollHeight"), (w = "scrollWidth"))),
      (T = T),
      s === x || ((s === P || s === W) && r === Ct))
    ) {
      p = B;
  ...
  if (((b = R.x), (N = R.y), l)) {
    ...
    return Object.assign(
      ...
      (M[p] = I ? "0" : ""),
      (M[E] = D ? "0" : ""),
      (M.transform = (m.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + N + "px)" : "translate3d(" + b + "px, " + N + "px, 0)"),
      M)
    );
  }
...
let Ae = class hr extends z {
  ...
  show() {
    ...
    if (
      (this._element.ownerDocument.documentElement.contains(this.tip) || (r.append(s), h.trigger(this._element, this.constructor.eventName(dc))),
  ...
  hide() {
    ...
    const i = () => {
      this._isWithActiveTrigger() ||
        (this._isHovered || this._disposePopper(), this._element.removeAttribute("aria-describedby"), h.trigger(this._element, this.constructor.eventName(lc)));
    };
...
let du = class dn extends z {
  constructor(t) {
    super(t),
      ...
      this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), h.on(this._element, nu, (e) => this._keydown(e)));
  }
  // Getters
  static get NAME() {
    return Xc;
...
class Nr extends Ln {
  constructor(t) {
    super(t),
      ...
      this._element && (this.init(), _.setDataAttribute(this._element, `${this.constructor.NAME}-initialized`, !0), H(this.constructor));
  }
  // Getters
  static get NAME() {
    return Fu;
  ...
  static clearMenus(t) {
    ...
    for (const i of e) {
      ...
      if (
        ...
        (s._menu.contains(t.target) && ((t.type === "keyup" && t.key === Ui) || /input|select|option|textarea|form/i.test(t.target.tagName)))
      )
        continue;
...
class Cr extends Ln {
  constructor(t, e) {
    super(t),
      ...
      this._element && (_.addClass(this._element, X), _.setDataAttribute(this._element, `${this.constructor.NAME}-initialized`, !0), H(this.constructor)),
  ...
  _autoInit(t) {
    ...
    if (!(this._element.classList.contains("btn") && e.rippleInit === !1)) {
      if (((this._options = this._getConfig()), this._element.tagName.toLowerCase() === "input")) {
        ...
        if (((this._rippleInSpan = !0), i.tagName.toLowerCase() === "span" && i.classList.contains(X))) this._element = i;
        else {
      ...
      (this._rippleTimer = setTimeout(() => {
        t &&
          ...
          this._element &&
            ...
            this._rippleInSpan && this._element.classList.contains(Zi) ? this._removeWrapperSpan() : _.removeClass(this._element, X)));
      }, e));
  }
  _removeWrapperSpan() {
  ...
  _addColor(t, e) {
    if (ih.find((s) => s === this._options.rippleColor.toLowerCase())) _.addClass(e, `${X}-${this._options.rippleColor.toLowerCase()}`);
    else {
